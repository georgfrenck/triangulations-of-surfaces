...
DEST = '/Users/frenckge/Documents/Teaching/WiSe 2023/Softwarepraktikum/triangulations-of-surfaces/input/'

# size of the circles:
n=20  # points on small circles or number of "equators" for genus=0
m=14  # points on large circles or number of "meridians" for genus=0
